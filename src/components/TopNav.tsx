        ...
        <div className="flex items-center justify-center flex-1 sm:items-center sm:justify-start">
          ...
          <div className=" sm:ml-6 sm:block">
            <div className="flex items-center space-x-4">
              <a
                href="##"
                className="px-3 py-2 text-xs font-medium text-black rounded-md "
              >
                message
              </a>
              ...
              <a
                href="@"
                className="px-3 py-2 text-xs font-medium text-black rounded-md hover:text-white"
              >
                Notification
              </a>
              ...
              <label className="mb-1 text-sm font-medium text-gray-900 sr-only dark:text-white">
                Search
              </label>
              ...
              <input
                type="search"
                id="default-search"
                className="text-sm text-gray-900 border border-gray-300 rounded-lg lg:hidden md:hidden pl1/3 10 h-25 w- bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div className="relative ml-5">
            ...
            {show ? (
              ...
              >
                ...
                <Link
                  to="/profile"
                  className="block px-4 text-gray-700 cursor-pointer txt-sm p-y-2 "
                  role="menuitem"
                  id="user-menu-item-0"
                >
                  Your Profile{' '}
